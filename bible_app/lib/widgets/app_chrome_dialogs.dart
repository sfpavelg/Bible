...
List<Widget> _helpContentInspirationVerse({
  ...
  return [
    ...
    Text(
      ...
      'Время задаётся кнопкой под переключателем. В уведомлении — ссылка на стих в заголовке и полный текст стиха в сообщении. '
      'Нажатие на уведомление открывает Библию с подсветкой нужного места.',
      style: bodyStyle,
    ),
    const SizedBox(height: 10),

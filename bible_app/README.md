...
- `1.1.1+16` (2026-04-29): в «Настройках» исправлены отступы ползунков и ограничение высоты окна над нижним тулбаром, в «Помощь» добавлено описание плана «Для начинающих», а в «Техподдержке» обновлён e-mail на `februaryidea7@gmail.com` и упрощено копирование контакта.

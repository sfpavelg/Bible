...
- `1.1.1+21` (2026-05-15): меню «⋯», блокнот и поиск Библии дополнительно выровнены под frost‑glass и лавандовый фон; в списке заметок — градиент как у области стихов, тёмно‑фиолетовые подписи, белый ореол у чекбокса массового выбора; панель «Избранное» — бледно‑фиолетовая подложка у пустого состояния; центральная надпись «совпадений не найдено» в поиске убрана при нуле результатов.
...
Если хочешь, следующим шагом могу сделать готовый чек-лист именно под твой проект (с точными файлами, командами и полями, которые ты заполняешь перед каждым релизом в RuStore).
